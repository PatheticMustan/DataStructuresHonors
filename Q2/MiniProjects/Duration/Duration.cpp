...
int main() {
    cout << "\nComplex Numbers! Wow. Select an option!\n"
         << "[1] Duration (hours, minutes, seconds)\n"
         << "[2] Duration (hours, minutes)\n"
         << "[3] Duration (hours)\n"
         << "[4] Add Two Durations\n"
         << "[5] Subtract Two Durations\n"
         << "[6] Multiply Two Durations\n"
         << "[7] Divide Two Durations\n"
         << "[8] Divide Duration by Double\n"
         << "[9] Get Random Duration\n"
         << "[10] Exit\n\n";
    ...
    switch (option) {
        ...
        case 2: {
            cout << "Please enter the hours, and minutes for a duration\n";
            int hours, minutes;
            cin >> hours >> minutes;
            Duration d(hours, minutes);
            
            cout << d;
            break;
        }
        case 3: {
            cout << "Please enter the hours for a duration\n";
            int hours;
            cin >> hours;
            Duration d(hours);
        ...
        case 4: {
            cout << (string)(getDurationFromInput() + getDurationFromInput());
            break;
        }
        case 5: {
            // apparently c++ evaluates the order of things differently than I expected
            //
            // OwO() - UwU()
            // 
            // the above line calls UwU first, I'm not sure why but to fix,
            // just put it on different lines.
            first = getDurationFromInput();
            second = getDurationFromInput();
        ...
        case 8: {
            first = getDurationFromInput();
            cout << "Please enter the double to divide the duration by\n";
            double div;
            cin >> div;
            cout << (string)(first / div);
            break;
        }
        case 9: {
            Duration d;
